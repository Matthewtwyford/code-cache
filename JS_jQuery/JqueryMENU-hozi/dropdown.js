...
(function($)
	...
	var delay=function(ev,ob){ob.hoverIntent_t=clearTimeout(ob.hoverIntent_t);ob.hoverIntent_s=0;
...
$(function () {
	...
	$('.dropdown a').hover(function () {
		$(this).stop(true).animate({paddingLeft: '10'}, {speed: 10, easing: 'easeOutBack'});
	}, function () {
		$(this).stop(true).animate({paddingLeft: '20'}, {speed: 10, easing: 'easeOutBounce'});
	});
